...
local Compile = loadstring(game:HttpGet("https://github.com/cybe42/exp-lvm/raw/refs/heads/main/Yueliang.lua"))()
local Wrap = loadstring(game:HttpGet("https://github.com/cybe42/exp-lvm/raw/refs/heads/main/FiOne.lua"))()
